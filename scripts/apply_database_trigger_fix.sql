-- Script to apply the database trigger fix

-- This script applies the fixed inventory trigger to remove status dependency

-- First, check if the function exists
SELECT proname FROM pg_proc WHERE proname = 'update_inventory_from_delivery';
