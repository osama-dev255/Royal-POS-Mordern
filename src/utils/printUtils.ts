...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .spn-qr-code {
      width: 70px; height: 70px; border: 1px solid #e2e8f0;
      border-radius: 4px; flex-shrink: 0;
    }
    .spn-header-text { flex: 1; text-align: center; }
    .spn-document-title {
      font-size: ${fontSize}px; font-weight: 800; letter-spacing: 1px;
      margin-bottom: 4px; text-transform: uppercase; color: #000;
    }
    .spn-document-number {
      font-size: ${fontSize}px; font-weight: 600; color: #000; letter-spacing: 0.5px;
    }
    .spn-copy-indicator {
      display: inline-block; margin-top: 4px; padding: 2px 8px;
      background: #fff; border: 1px solid #000; border-radius: 3px;
      font-size: ${fontSize}px; font-weight: 700; letter-spacing: 0.5px;
    ...
    .meta-bar-label {
      font-size: ${fontSize}px; font-weight: 600; text-transform: uppercase;
    ...
    .items-table {
      width: 100%; border-collapse: collapse; font-size: ${fontSize}px;
      border: 1px solid #d1d5db;
    }
    ...
    .items-table .item-num { font-weight: 700; color: #000; font-size: ${fontSize}px; }
    ...
    .items-table tfoot td {
      ...
      border-right: 1px solid #e5e7eb; background: #f3f4f6; font-size: ${fontSize}px;
    }
    ...
    .payment-label { color: #000; font-size: ${fontSize}px; }
    .payment-value { font-weight: 600; color: #000; font-size: ${fontSize}px; }
    ...
    .sig-label {
      font-size: ${fontSize}px; color: #000; text-transform: uppercase;
      letter-spacing: 0.3px; margin-bottom: 1px;
    }
    .sig-value { font-size: ${fontSize}px; font-weight: 600; color: #000; }
    .sig-line {
    ...
    .footer-thankyou { font-size: ${fontSize}px; font-weight: 700; letter-spacing: 0.3px; }
    .footer-generated { font-size: ${fontSize}px; opacity: 0.8; }
    .footer-bottom {
      text-align: center; padding-top: 6px; border-top: 1px solid rgba(255,255,255,0.2);
      font-size: ${fontSize}px; opacity: 0.7; letter-spacing: 0.3px;
    }
  </style>
</head>
<body>
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  static printInternalConsumptionNote(note: any) {
    const fmt = (n: number) => n.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
    const n = note;
